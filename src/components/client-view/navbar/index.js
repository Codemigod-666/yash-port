...
function CreateMenus({ activeLink, getMenuItems, setActiveLink }) {
  return getMenuItems.map((item, index) => (
    ...
    ${
      activeLink === item.id
        ? "text-green-main font-bold animation-active shadow-green-main"
        ...
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          <div className="col-start-1 col-end-2 flex items-center">
            <div className="cursor-pointer flex gap-1 font-bold items-center text-[20px] text-green-main">
              <div className="w-[44px] h-[45px] flex justify-center items-center p-3 rounded-[8px] border-green-main bg-green-main">
                <span className="text-[#fff] text-[28px] font-bold">Y</span>
              </div>
                ash-Portfolio
            </div>
          </div>
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-center items-center">
            <button
              ...
              className="py-2 px-4 border-[2px] text-[#fff] border-green-main bg-green-main font-bold rounded-lg text-xl hover:shadow-green-md transition-all outline-none"
            >
              Contact Me
            </button>
          </div>
