...
import aiImage from '../../../../public/assets/yash2.png';
function variants() {
  return {
    offscreen: {
      y: 150,
        ...
        >
            ...
            <motion.div className="flex gap-3 cursor-pointer">
              {socialIcons.map((item) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.2, rotate: 360, borderRadius: '100%' }}
          ...
          <motion.div ref={containerRef} className="flex w-full justify-end">
            <motion.div
              ...
              className="w-[400px] h-[400px] relative rounded-full bg-green-main"
            >
              <div className="w-[400px] h-[400px] top-[50px] left-[-40px] rounded-full border-[6px] border-[#000000] absolute"></div>
              <Image
                src={aiImage}
                alt="Profile Picture"
                layout="responsive"
